...
const config: CapacitorConfig = {
  ...
  plugins: {
    // Use the App Group suite so @capacitor/preferences reads the same UserDefaults
    // that the Share Extension writes to (pendingShareURL, pendingShareImageBase64, etc.)
    Preferences: {
