...
export const models = {
  ...
  // Vision-based extraction — used when the page is anti-scraped (Xiaohongshu, WeChat)
  // and an image payload is available from the iOS Share Sheet.
  // Sonnet handles Chinese text in screenshots significantly better than Haiku.
