...
export const models = {
  ...
  // Vision extraction — used when the share payload includes an image (e.g. Xiaohongshu/WeChat
  // blocks URL scraping, so we fall back to reading the post screenshot via Claude Vision)
