...
export const models = {
  ...
  // Vision-based extraction: used when URL scraping fails (Xiaohongshu, WeChat anti-scraping).
  // Sonnet handles dense Chinese-language social posts and text overlays better than Haiku.
