...
export const models = {
  ...
  // Vision extraction — used when image payload is available (e.g. Xiaohongshu anti-scrape bypass).
  // Sonnet handles Chinese text in images and complex layouts better than Haiku.
