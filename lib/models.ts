...
export const models = {
  ...
  // Vision extraction — used when an image is provided (Xiaohongshu, Share Sheet screenshots)
  // Sonnet has stronger image understanding than Haiku for complex travel content
