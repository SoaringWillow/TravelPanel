...
import { Globe2, Inbox, LayoutGrid, BookOpen, Settings2 } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { key: 'timeline', label: 'Journal',     icon: BookOpen,   href: '/timeline'  },
...
export default function NavBar({ active }: NavBarProps) {
  return (
    <nav
      className="fixed bottom-0 left-0 right-0 z-[1000] bg-white/95 dark:bg-gray-950/95 backdrop-blur-md"
