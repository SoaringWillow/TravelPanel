...
// Reads a pending share (URL + title + optional image) stored by the iOS Share Extension
      ...
      try {
        ...
        const listener = await App.addListener('appUrlOpen', async ({ url }) => {
          try {
            ...
            if (shareUrl) {
              // Check App Group for image written by ShareViewController alongside the URL
              try {
