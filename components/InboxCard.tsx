...
import { lightTap, errorVibration } from '@/lib/haptics';
        ...
        <div className="p-4 space-y-2">
          ...
          <div className="flex items-center justify-between pt-1">
            ...
            <div className="flex items-center gap-1">
              ...
              <button
                type="button"
                onClick={() => { errorVibration(); onDelete(item.id); }}
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between pt-2 border-t border-gray-50">
          ...
          <div className="flex items-center gap-1">
            ...
            <button
              type="button"
              onClick={() => { lightTap(); onViewOnMap(item.id); }}
            ...
            {onMoveToBoard && (
              <button
                type="button"
                onClick={() => { lightTap(); onMoveToBoard(item.id); }}
