      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-4 space-y-3">
        ...
        <div className="flex items-center justify-between pt-1">
          {isRetrying ? (
            ...
            <span className="text-xs text-amber-600 dark:text-amber-500 font-medium">⚠ Analysis failed</span>
          )}
          <div className="flex items-center gap-1.5">
            <a
              href={item.url}
            ...
            {!isRetrying && onRetry && (
              <button
                ...
                className="text-xs font-medium px-3 py-1.5 rounded-lg border border-amber-300 dark:border-amber-700 text-amber-700 dark:text-amber-500 hover:bg-amber-50 dark:hover:bg-amber-900/30 transition-colors"
              >
                Retry
              </button>
            )}
