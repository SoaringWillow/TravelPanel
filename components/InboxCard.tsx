...
export default function InboxCard({
  ...
  if (enrichmentStatus === 'pending' || (enrichmentStatus === 'processing' && !isRetrying)) {
    if (!item.title || item.title === item.url) {
      ...
      return (
        <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm dark:shadow-none border border-gray-100 dark:border-gray-800 overflow-hidden animate-pulse">
    ...
    return (
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm dark:shadow-none border border-gray-100 dark:border-gray-800 overflow-hidden">
          ...
          <div className="flex items-center justify-between pt-1">
            ...
            <div className="flex items-center gap-1">
              <a
                ...
                className="p-1.5 text-gray-400 dark:text-gray-500 hover:text-indigo-500 hover:bg-indigo-50 rounded-lg transition-colors"
  ...
  if (enrichmentStatus === 'failed' || isRetrying) {
    ...
    return (
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm dark:shadow-none border border-gray-100 dark:border-gray-800 p-4 space-y-3">
        <div className="flex items-center gap-2 flex-wrap">
          <span
            className={`${PLATFORM_BG[item.platform]} text-white text-xs font-medium px-2.5 py-0.5 rounded-full flex-shrink-0`}
          >
  ...
  return (
    <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm dark:shadow-none border border-gray-100 dark:border-gray-800 overflow-hidden">
      ...
      <div className="p-4">
        ...
        {/* Title */}
        <h3 className="font-semibold text-gray-800 dark:text-white text-sm leading-snug line-clamp-2 mb-1">
          {item.title}
        </h3>
          ...
          <div className="flex items-center gap-1">
            ...
            {onMoveToBoard && (
              <button
                ...
                className="p-1.5 text-gray-400 dark:text-gray-500 hover:text-gray-600 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors"
