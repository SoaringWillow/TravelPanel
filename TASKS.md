...
**Implemented**: `extension/` — MV3 extension with popup UI, context menus, OffscreenCanvas icon, platform detection, smart tab reuse, and configurable TravelPanel URL. See `extension/INSTALL.md` for load instructions and Safari conversion steps.
