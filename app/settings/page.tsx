  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-24">
      ...
      <div className="max-w-lg mx-auto px-4 py-6 flex flex-col gap-6">
        ...
        <section className="bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-sm">
          <div className="px-5 py-4 border-b border-gray-50">
            <h2 className="text-sm font-semibold text-gray-900">Backup &amp; Restore</h2>
            <p className="text-xs text-gray-400 mt-0.5">Export your clips, boards, and trip plans as a JSON file.</p>
          </div>
          ...
          <div className="p-5 flex flex-col gap-3">
            ...
            <button
              ...
              className="w-full flex items-center gap-3 px-4 py-3.5 rounded-xl bg-gray-100 text-gray-700 font-semibold text-sm hover:bg-gray-200 active:scale-[0.98] transition-all disabled:opacity-70"
            >
        ...
        <section className="bg-white rounded-2xl border border-gray-100 overflow-hidden shadow-sm">
          ...
          <div className="px-5 py-4 flex flex-col gap-3">
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <span className="font-medium text-gray-900">Substance over Spots</span>
            </div>
            <div className="flex items-center justify-between text-sm">
