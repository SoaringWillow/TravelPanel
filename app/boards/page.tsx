      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 pb-24">
        {boardsLoading ? (
          ...
          <EmptyState
            ...
            subtitle="Group your travel clips into boards — a Tokyo trip, a beach getaway, weekend escapes — and let AI build you a day-by-day itinerary from your saves."
            action={{ label: '+ New Collection', onClick: () => setShowCreate(true) }}
            className="h-80"
          />
        ) : (
