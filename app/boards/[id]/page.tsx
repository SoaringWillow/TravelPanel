...
import { ArrowLeft, Rocket, MapPin, Share2, Copy, Check } from 'lucide-react';
    ...
    <div className="flex flex-col h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <div className="bg-white dark:bg-gray-900 shadow-sm px-4 pt-12 pb-4 z-10">
        <div className="flex items-center gap-3">
          ...
          <span className="bg-indigo-100 dark:bg-indigo-900/50 text-indigo-700 dark:text-indigo-300 text-xs font-semibold px-2.5 py-1 rounded-full flex-shrink-0">
            ...
            {hasLocations ? (
              ...
              <div className="relative group">
                <button
                  type="button"
                  disabled
                  className="w-full flex items-center justify-center gap-2 bg-gray-200 dark:bg-gray-800 text-gray-400 dark:text-gray-600 font-semibold py-3.5 rounded-2xl cursor-not-allowed"
                >
                  <Rocket size={18} />
                  Plan this trip
                </button>
